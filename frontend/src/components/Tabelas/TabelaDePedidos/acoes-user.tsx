...
import { useOrcamentosDoUsuarioQuery } from "@/hooks/queries/orcamento/useOrcamentosDoUsuarioQuery";
...
export const AcoesUser = ({ id }: IProps) => {
  ...
  useEffect(() => {
    if (orcamentosDoUsuarioQuery.data && pedidosDoUsuarioQuery.data) {
      const merge = [
        ...orcamentosDoUsuarioQuery.data,
        ...pedidosDoUsuarioQuery.data,
      ];

      setPedido(merge.find((p) => p._id === id));
    }
  }, [pedidosDoUsuarioQuery.data, orcamentosDoUsuarioQuery.data, id]);
      ...
      <DropdownMenuContent align="end">
        ...
        {pedido && (
          <>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={clonar} disabled={!pedido._id}>
              Clonar
            </DropdownMenuItem>
