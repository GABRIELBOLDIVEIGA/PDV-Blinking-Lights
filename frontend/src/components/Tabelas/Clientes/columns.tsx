...
import { ClienteTable } from "@/hooks/queries/tables/clientes/cliente-table";
import { ScrollArea } from "@/components/ui/scroll-area";

export const columns: ColumnDef<ClienteTable>[] = [
  {
    accessorKey: "nome",
    header: ({ column }) => {
      return (
  ...
  {
    id: "Usuário Responsavel",
    accessorKey: "usuario_responsavel",
    header: ({ column }) => {
      return (
        <div className="w-fit">
          <Button
      ...
      return (
        <div className="w-fit pl-2 capitalize">
          <p className="text-wrap">
            {row.original.usuario_responsavel.toLowerCase()}
          </p>
        </div>
      );
    },
