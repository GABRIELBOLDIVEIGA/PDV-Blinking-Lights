...
import { useTabelaProdutosStore } from "@/store/colunas-tabelas/useTabelaProdutosStore";
...
export function TabelaProdutos<TData, TValue>({
  data,
  columns,
  ...
  const { changeIsVisible } = useTabelaProdutosStore();
  const opt = useTabelaProdutosStore((state) => state.opt);
